...
const BasketItemRow = ({basket, navigation}) => {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={() => {navigation.navigate("BasketDetails",{basket, totalCalories, setTotalCalories})}} >
